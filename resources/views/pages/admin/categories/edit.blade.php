                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="custom-tabs-general" role="tabpanel" aria-labelledby="custom-tabs-general-tab">
                                    <div class="form-group text-center">
                                        ...
                                        <div class="mb-3">
                                            <img id="imagePreviewLogo" src="{{$item->image_path?asset('storage/'.$item->image_path):'https://via.placeholder.com/600x200'}}" alt="Banner Preview" class="rounded shadow image-preview" style="max-height: 200px; width: 600px; object-fit: cover; border: 2px solid #ddd;">
                                        </div>
