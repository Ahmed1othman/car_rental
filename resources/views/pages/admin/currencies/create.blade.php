    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="display-4">Add Currency</h1>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="tab-content" id="custom-tabs-three-tabContent">
                                <div class="tab-pane fade show active" id="custom-tabs-general" role="tabpanel" aria-labelledby="custom-tabs-general-tab">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="code" class="form-control form-control-lg shadow-sm" id="code" value="{{ old('code') }}" placeholder="e.g., USD, EUR">
                                    </div>

                                    <div class="form-group">
                                        <label for="symbol" class="font-weight-bold">Symbol</label>
                                        <input type="text" name="symbol" class="form-control form-control-lg shadow-sm" id="symbol" value="{{ old('symbol') }}" placeholder="e.g, $, €">
                                    </div>
                                    <div class="form-group">
                                        <label for="name" class="font-weight-bold">Name</label>
                                        <input type="text" name="name" class="form-control form-control-lg shadow-sm" id="name" value="{{ old('name') }}" placeholder="Currency name">
                                    </div>
                                    <div class="form-group">
                                        <label for="exchange_rate" class="font-weight-bold">Exchange Rate</label>
                                        <input type="number" step="0.0001" name="exchange_rate" class="form-control form-control-lg shadow-sm" id="exchange_rate" value="{{ old('exchange_rate') }}" placeholder="Exchange rate">
                                    </div>
                                    <div class="form-group">
                                        <label for="is_default" class="font-weight-bold">Default Currency</label>
                                        <div class="custom-control custom-switch">
                                            <input type="checkbox" name="is_default" class="custom-control-input" id="is_default" {{ old('is_default') ? 'checked' : '' }}>
